    ...
    <>
      ...
      <div className="bg-white min-h-screen">
        ...
        <div className="pt-40 md:pt-40">
          ...
          {/* Buy Now Button */}
          <div className="text-center py-20 pb-20 md:py-28 md:pb-28">
            <a
            ...
            >
              <button
                ...
                className="text-white font-bold py-3 px-6 md:py-4 md:px-12 rounded inline-block text-lg md:text-xl transform transition-all duration-300 hover:bg-red-900 hover:scale-105 hover:shadow-2xl animate-shake animate-infinite animate-duration-1000 animate-ease-linear"
              >
                Buy Now
              </button>
            </a>
